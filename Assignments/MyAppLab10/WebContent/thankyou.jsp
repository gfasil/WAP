...
<div class="container mainsection col-9"><p style="float:right"> <%= new java.util.Date() %></p></div>
...
<div class="container mainsection col-9">
 <div class="card bg-light mb-3 " style=" margin-top:5rem">
  ...
  <div class="card-body">
    ...
    <p class="card-text"><span>Name</span><%=
 
    session.getAttribute("name") %></p>
    <p class="card-text"><span>Gender</span><%= request.getAttribute("gender") %></p>
     <p class="card-text"><span>Category</span><%= request.getAttribute("category") %></p>
    <p class="card-text"><span>Message</span><%= request.getAttribute("message") %></p>
  </div>
